...
public class LoginController {
	...
	login(HttpServletRequest request, HttpServletResponse response) throws
	Exception { request.setCharacterEncoding("utf-8"); ModelAndView mav = new
	ModelAndView(); mav.setViewName("result"); String userID =
	request.getParameter("userID"); String userName =
	request.getParameter("userName"); mav.addObject("userID", userID);
	 ...
	 * System.out.println("userName: "+userName); mav.addObject("userID", userID);
	 * mav.addObject("userName", userName); return mav; }
	 */
	 ...
	 * 
	 * @RequestParam(value="email", required=false) String email, HttpServletRequest
	 ...
	 * 
	 * System.out.println("userID: "+userID);
	 * System.out.println("userName: "+userName); System.out.println("email: "+
	 * email); mav.addObject("userID", userID); mav.addObject("userName", userName);
	 * return mav; }
	 */
